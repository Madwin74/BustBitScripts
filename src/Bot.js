...
function MeroBot(){
	...
	console.log("Target Multiplier: " + (gameConfig.TARGET * betMultiplier).toFixed(0));
        this.socket.emit('place_bet', currentBet, (gameConfig.TARGET * betMultiplier).toFixed(0) , function(err) {
            if (err) {
